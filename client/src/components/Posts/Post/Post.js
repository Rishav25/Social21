    ...
    return (
        <Card className={design.card}>
            ...
            <CardActions className={design.cardActions}>
                <Button style={{color : '#25F4EE'}} size="small" onClick={()=> dispatch(likePost(post._id))}>
                    <ThumbUpAltIcon style={{color : '#25F4EE'}} fontsize="small"/>
                    {post.likeCount} Likes
                </Button>
                <Button style={{color : '#fe2c55'}} size="small" onClick={()=> dispatch(deletePost(post._id))}>
                    <DeleteIcon style={{color : '#fe2c55'}} fontsize="small"/>
                    Delete
                </Button>
            </CardActions>
        </Card>    
